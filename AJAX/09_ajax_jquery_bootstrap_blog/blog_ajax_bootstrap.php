...
// require_once("inc/nav.inc.php");  pour charger une éventuelle nav
?>
    ...
    <div class="container">
        ...
        <div class="col-sm-6 col-sm-offset-3">
            ...
            <div class="col-sm-6 col-sm-offset-3">
                ...
                <h1>
                    <span class="glyphicon glyphicon-user" style="color: lightslategray"></span>
                    &nbsp;Liste des articles
                </h1>
                <hr />
            </div>
    ...
    <script>
        //  à placer de préférence dans le footer.inc.php avec la ligne au dessus d'appel du jquery
