...
-- Les requêtes préparéées sont des requêtes qui dissocient les phases Analyse / Interprétation / Exécution. La préparation de la requête consiste à réaliser les étapes d'analyse et d'interprétation. Ensuite on effectue l'exécution à part.
