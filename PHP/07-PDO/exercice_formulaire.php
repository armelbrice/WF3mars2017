...
if (!empty($_POST)) {  // si le formulaire est posté, il y a des indices dans $_POST, il n'est donc pas vide
	...
	if (empty($message)) {  // si les messages sont vides, c'est qu'il n'y a pas d'erreur
		...
		// 4- Afficher un message "L'emplopyé a été ajouté" :
...
<form method= "post" action="">
	...
	<input type="radio" name="sexe" id="femme" value="f"><label for="femme">Femme</label>
	<br><br>
	...
	<input type="text" id="date_embauche" name="date_embauche" placeholder="AAAA-MM-JJ"><br><br>

	<label for="salaire">Salaire</label><br>
	<input type="text" id="salaire" name="salaire"><br><br>
