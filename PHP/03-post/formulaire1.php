...
// Un formulaire est obligatoirement dans des balises <form></form>, avec la désignation des attributs method (pour get ou post) et action (qui indique le fichier de destination des données du formulaire). Il contient un bouton de type submit qui déclenche l'envoie des données vers le serveur.
