...
session_start();  // lorsque j'effectue un session_start(), la session n'est pas recréée car elle existe déja grace au session_start() lancé dans le fichier session1.php.
