...
if (empty($_SESSION['panier']['id_produit'])) {
	...
	echo '<table class="table">';
		...
		if (internauteEstConnecte()) {
			...
			// Membre non connecté, on l'invite à s'inscrire ou à se conencter
			echo '<tr class="text-center">
						<td colspan="5">
							Veuillez vous <a href="inscription.php"> inscrire </a> ou vous <a href="connexion.php"> connecter </a> afin de pour valider le panier
						</td>
				  </tr>';
		}
