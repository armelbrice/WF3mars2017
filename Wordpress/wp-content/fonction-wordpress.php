<?php
    ...
    */
    ...
    // installer image widget/widget blocks pour placer le logo
    ...
    dynamic_sidebar ('region-du-haut-gauche');
     ...
     register_sidebar (array(
        'name'          => 'region du haut au milieu',
        'id'            => 'region-du-haut-milieu',
        'description'   => 'region en haut au milieu',
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h1 class="widget-title">',
        'after_title'   => '</h1>'
    ...
    dynamic_sidebar ('region-du-haut-milieu');
