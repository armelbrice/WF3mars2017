...
<table class="widefat" cellspacing="0">
	...
	<tbody>
		<tr class="alternate">
			<td><img src="<?php echo plugins_url('images/techgasp-linkedinmaster-logo.png', dirname(__FILE__)); ?>" alt="<?php echo $plugin_master_name; ?>" align="left" width="387px" height="171px" style="padding:5px;"/></td>
			<td>
