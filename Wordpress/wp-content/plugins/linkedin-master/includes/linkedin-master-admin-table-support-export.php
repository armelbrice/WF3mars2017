...
include_once($_SERVER['DOCUMENT_ROOT'].'/wp-load.php' );
	...
	$plugin_master_version = constant('LINKEDIN_MASTER_VERSION');
	...
	if( is_multisite() ){
		...
		$license = get_blog_option($blog_id, 'linkedin_license_key');
		$status = get_blog_option($blog_id, 'linkedin_license_status' );
		$status_error = get_blog_option($blog_id, 'linkedin_license_error' );
		$license_expires = get_blog_option($blog_id, 'linkedin_license_expires' );
		...
		$license = get_option('linkedin_license_key');
		$status = get_option( 'linkedin_license_status' );
		$status_error = get_option( 'linkedin_license_error' );
		$license_expires = get_option( 'linkedin_license_expires' );
