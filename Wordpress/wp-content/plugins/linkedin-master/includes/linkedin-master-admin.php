...
if ( is_admin() )
add_menu_page( 'Linkedin Master', 'Linkedin Master', 'manage_options', 'linkedin-master', 'linkedin_master_admin', plugins_url( 'linkedin-master/images/techgasp-minilogo-16.png' ) );
}
		///////////////////////
		// WORDPRESS ACTIONS //
		///////////////////////
...
if(!class_exists('linkedin_master_admin_table_header')){
	require_once( dirname( __FILE__ ) . '/linkedin-master-admin-table-header.php');
}
...
if(!class_exists('linkedin_master_admin_table_news')){
	require_once( dirname( __FILE__ ) . '/linkedin-master-admin-table-news.php');
}
//Prepare Table of elements
...
<?php
if(!class_exists('linkedin_master_admin_table_support')){
	require_once( dirname( __FILE__ ) . '/linkedin-master-admin-table-support.php');
}
//Prepare Table of elements
$wp_list_table = new linkedin_master_admin_table_support();
//Table of elements
$wp_list_table->display();
